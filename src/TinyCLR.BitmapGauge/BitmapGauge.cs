...
using TinyCLR.BitmapGauge.Properties;
...
namespace TinyCLR.BitmapGauge
{
    public partial class BitmapGauge
    {
        ...
        public Font font { get; set; } = Resources.GetFont(Resources.FontResources.NinaB);
        ...
        private void DrawGloss(Graphics g)
        {
            RectangleF glossRect = new RectangleF(
               ...
               (float)(width * 0.80),
               (float)(height * 0.7));
            SolidBrush gradientBrush = new SolidBrush(Color.White);
            /*
